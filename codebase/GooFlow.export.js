...
GooFlow.prototype.exportDiagram=function(fileName) {
    ...
    $("body").append('<div id="demo_export" css="position:absolute;top:0;left:0;z-index:-1;width:0px;height:0px;overflow:hidden">'
        +'<div css="color:#15428B;position:absolute;left:0;right:0;width:'+width+'px;height:'+height+'px;overflow:hidden;float:none;" class="GooFlow GooFlow_work"></div>'
        +'</div>');
    ...
    html2canvas(divCanvas[0], {
        ...
        onrendered: function(canvas) {
            ...
            var strSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="1160" height="507">'
                +'<defs><css type="text/css">text{font-size:14px;line-height:1.42857143;'
                +'font-family:"Microsoft Yahei", "Helvetica Neue", Helvetica, Hiragino Sans GB, WenQuanYi Micro Hei, Arial, sans-serif;'
                +'}</css></defs>' + window.$("<svg>").append(window.$("#draw_demo").clone()).html() +'</svg>'; //COPY连线内容
            var image = null;
